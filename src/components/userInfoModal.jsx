    ...
    <div className="MY-4 bg-gray-100 flex items-center justify-center p-6">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-lg p-8">
        ...
        <button
          ...
          className="w-full bg-emerald-700 text-white py-3 rounded-lg font-medium hover:bg-emerald-700 transition duration-300"
        >
          Proceed
        </button>
      </div>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-gray-500 bg-opacity-50 flex justify-center items-center">
          <div className="bg-white rounded-lg shadow-lg p-8 w-96">
            <h2 className="text-2xl font-semibold text-emerald-700 text-center mb-4">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="flex justify-between">
                ...
                <button
                  type="submit"
                  className="bg-emerald-800 text-white py-2 px-4 rounded-lg hover:bg-emerald-700"
                >
                  Submit
                </button>
              </div>
